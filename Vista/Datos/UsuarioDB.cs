    ...
    public class UsuarioDB
    {
        ...
        public bool Insertar(Usuario user)
        {
            ...
            try
            {
                ...
                sql.Append(" (@CodigoUsuario, @Nombre, @Contrasena, @Correo, @FechaCreacion, @EstaActivo); ");
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    _conexion.Open();
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
        ...
        public bool Editar(Usuario user)
        {
            ...
            try
            {
                ...
                sql.Append(" Nombre = @Nombre, Contrasena = @Contrasena, Correo = @Correo, EstaActivo = @EstaActivo ");
